...
from modules import Conv, DownSampling
...
class Encoder_Decoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # 上采样部分,拼接
        O1 = self.upSample_Conv_1(self.upSample_1(Y1))
        O2 = self.upSample_Conv_2(self.upSample_2(O1))
        O3 = self.upSample_Conv_3(self.upSample_3(O2))
        O4 = self.upSample_Conv_4(self.upSample_4(O3))
